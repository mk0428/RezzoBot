...
const posts = [
  {
    ...
    excerpt: 'If you've applied to dozens of jobs and never heard back, an ATS resume checker can tell you why. Learn how these tools work and whether you need one.',
    date: 'July 20, 2026',
    readTime: '4 min read',
  },
  {
